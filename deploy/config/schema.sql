...
VALUES (1, 'System Admin', 'admin@spedlms.local',
        ...
        'admin', 'active', TRUE, 'local', 1);

-- Demo accounts (password: password)
INSERT IGNORE INTO users (id, name, first_name, last_name, email, contact_number, password_hash, role, status, email_verified, auth_provider, school_id) VALUES
(2,  'Demo Parent',         'Demo', 'Parent',         'demo.parent@spedlms.local',         '09123456701', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'parent',          'active', TRUE, 'local', NULL),
(3,  'Demo SPED Teacher',   'Demo', 'SPED Teacher',   'demo.sped@spedlms.local',           '09123456702', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'sped_teacher',    'active', TRUE, 'local', 1),
(4,  'Demo Guidance',       'Demo', 'Guidance',       'demo.guidance@spedlms.local',       '09123456703', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'guidance',        'active', TRUE, 'local', 1),
(5,  'Demo Principal',      'Demo', 'Principal',      'demo.principal@spedlms.local',      '09123456704', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'principal',       'active', TRUE, 'local', 1),
(6,  'Demo Master Teacher', 'Demo', 'Master Teacher', 'demo.master@spedlms.local',         '09123456705', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'master_teacher',  'active', TRUE, 'local', 1),
(7,  'Demo Learner',        'Demo', 'Learner',        'demo.learner@spedlms.local',        '09123456706', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'learner',         'active', TRUE, 'local', 1);
