        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <select class="form-select" id="target_school_id" name="target_school_id">
                        ...
                        foreach ($schoolList as $sch) {
                            $sel = ($selectedSchoolId == $sch['id']) ? 'selected' : '';
                            echo '<option value="' . htmlspecialchars($sch['id']) . '" ' . $sel . '>' . htmlspecialchars($sch['school_name']) . ' (ID: ' . htmlspecialchars($sch['school_id']) . ')</option>';
                        }
                        ?>
                    </select>
                    <div class="form-text">Select the SPED school/center where you want to enroll your child</div>
                </div>
