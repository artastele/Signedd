<?php
// Remote seed script to create 3 demo pending staff accounts for Piedad Central Elementary School
...
try {
    ...
    echo "--- SEEDING DEMO STAFF ON LIVE REMOTE DB ---\n";
    echo "School ID: {$schoolId} ({$schoolName})\n";
    ...
    echo "SUCCESS: 3 Demo staff accounts seeded in live remote DB!\n";
} catch (Exception $e) {
