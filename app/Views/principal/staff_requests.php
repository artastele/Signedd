<?php
$pageTitle = 'Staff Requests - Principal - SPED LMS';
...
<div class="main-content">
    <h1 class="mb-4">
        <i class="bi bi-person-check"></i> Staff Role Requests
    </h1>

    <div class="alert alert-info">
        <i class="bi bi-info-circle"></i> 
        <strong>Your Approval Authority:</strong> As Principal, you approve role requests for SPED Teachers, Guidance Counselors, and Master Teachers.
    </div>
        ...
        <div class="card-body">
            <?php if (empty($requests)): ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mt-3">No staff role requests found.</p>
                </div>
            <?php else: ?>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">
                                                    <?php echo $request['status'] === 'pending' ? 'Review' : 'View'; ?> Staff Request
                                                </h5>
                                            ...
                                            <?php if ($request['status'] === 'pending'): ?>
                                                <div class="modal-footer">
                                                    <form method="POST" action="<?php echo $basePath; ?>/principal/staff-requests/<?php echo $request['id']; ?>/approve" class="d-inline">
                                                        <div class="mb-2">
                                                    ...
                                                    <form method="POST" action="<?php echo $basePath; ?>/principal/staff-requests/<?php echo $request['id']; ?>/reject" class="d-inline">
                                                        <div class="mb-2">
