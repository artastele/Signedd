    ...
    <div class="container-fluid py-4">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-0">
                ...
                $attendanceListStudentModel = new StudentModel();
                $attendanceListCodeCache = [];
                ?>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php foreach ($learners as $learner): ?>
                                    ...
                                    if ($learnerFk && !isset($attendanceListCodeCache[$learnerFk])) {
                                        $learnerRec = $attendanceListStudentModel->findById($learnerFk);
                                        $attendanceListCodeCache[$learnerFk] = $learnerRec['student_id'] ?? null;
                                    }
                                    ?>
                                    <tr>
                                        <td class="fw-semibold"><?php echo htmlspecialchars($learner['student_name']); ?></td>
                                        <td><?php echo htmlspecialchars(StudentDisplayHelper::formatStudentId($attendanceListCodeCache[$learnerFk] ?? null)); ?></td>
                                        <td><?php echo htmlspecialchars(StudentDisplayHelper::formatDepEdLrn($learner['lrn'] ?? null)); ?></td>
